...
This is no longer required as of beta 0.6.4, BounShell will automatically prompt to install/update any required modules when you exit the Settings menu.
